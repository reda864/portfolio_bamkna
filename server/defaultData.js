export const defaultTeamData = {
  ...
  stats: [
    { id: "stat-1", value: 2022, label: "Fondée en", suffix: "" },
    { id: "stat-2", value: 20, label: "Tournois", suffix: "+" },
    { id: "stat-3", value: 12, label: "Villes", suffix: "+" },
    { id: "stat-4", value: 4, label: "Joueurs", suffix: "" },
  ],
  players: [
    {
      id: 1,
  ...
  achievements: [
    { id: "ach-1", icon: "🥇", value: 3, label: "Titres 2025", suffix: "" },
    { id: "ach-2", icon: "🥈", value: 2, label: "Finales 2024", suffix: "" },
    { id: "ach-3", icon: "🏀", value: 20, label: "Tournois joués", suffix: "+" },
  ],
  results: [
    { id: "res-1", result: "🥇 1er", event: "3x3 ESM Michlifen — Ifrane", date: "Juil. 2025" },
    { id: "res-2", result: "🥇 1er", event: "3x3 Élite Meknès — Meknès", date: "Mars 2026" },
    { id: "res-3", result: "🥈 2ème", event: "Hay El Mohammadi 3x3 — Casablanca", date: "Mai 2024" },
    { id: "res-4", result: "🥈 2ème", event: "3x3 ESM Michlifen — Ifrane", date: "Mars 2026" },
    { id: "res-5", result: "🥉 3ème", event: "3x3 Taoujdate — Taoujdate", date: "Sept. 2024" },
    { id: "res-6", result: "🥉 3ème", event: "Meknès 3x3 Vol.2 — Meknès", date: "Juil. 2025" },
    { id: "res-7", result: "🥉 3ème", event: "Morocco Tour Quest — Agadir", date: "Août 2025" },
    { id: "res-8", result: "🥇 1er", event: "3x3 Martil — Martil", date: "Août 2024" },
  ],
  galleryItems: [
  ...
  tournaments: [
    { id: "tour-1", date: "15 Juin 2026", location: "Rabat", opponent: "Morocco Tour FRMBB — Stop 2" },
    { id: "tour-2", date: "20 Juil. 2026", location: "Ifrane", opponent: "3x3 ESM Michlifen" },
    { id: "tour-3", date: "05 Août 2026", location: "Tanger", opponent: "Morocco Tour Quest — Stop 1" },
    { id: "tour-4", date: "12 Août 2026", location: "Agadir", opponent: "Morocco Tour Quest — Stop 2" },
    { id: "tour-5", date: "25 Août 2026", location: "Casablanca", opponent: "3x3 Morocco Tour International" },
  ],
  sponsors: [
    { id: "spon-1", name: "Nike", description: "Équipementier officiel", logo: "/images/sponsors/nike.png" },
    { id: "spon-2", name: "Wilson", description: "Ballons & équipement basketball", logo: "/images/sponsors/wilson.png" },
    { id: "spon-3", name: "Red Bull", description: "Énergie & performance", logo: "/images/sponsors/redbull.png" },
  ],
  partnership: {
